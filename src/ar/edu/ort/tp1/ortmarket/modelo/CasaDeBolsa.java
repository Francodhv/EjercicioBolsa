...
public class CasaDeBolsa {
	...
	public CasaDeBolsa() {
		...
		clientes = new Cliente[MAXIMO_CLIENTES];
	...
	public void cargarOrden(int cantidad, String codigoInstrumento, int dniCliente, boolean esVenta) throws RuntimeException {
		// TODO: A completar
		InstrumentoFinanciero instrumentoFinanciero = instrumentos.search(codigoInstrumento);
		...
		ordenesPendientes.add(new Orden(cantidad, instrumentoFinanciero, clientes[posCliente], esVenta));
	}
